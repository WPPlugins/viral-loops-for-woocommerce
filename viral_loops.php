    ...
    class Viralloops
    {
        ...
        public function extra_scripts()
        {
			?>
				...
				<script>
					(function() {
						...
						if (getCookie("vl_guest_checkout")) {
							deleteCookie("vl_guest_checkout");
						}
            ...
            if (is_user_logged_in()) {
				...
				//guest checkout
				if (isset($_COOKIE['vl_guest_checkout'])) {
					$this->register_guest_action($_COOKIE['vl_guest_checkout']);
				}
			}
        }
		...
		public function register_guest_action($email)
        {
			$payloadArray = array(
				"apiToken"=>get_option( 'viral-loops-api-key' ),
				"params"=>array(
